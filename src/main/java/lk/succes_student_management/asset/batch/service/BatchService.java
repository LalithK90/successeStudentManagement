...
public class BatchService implements AbstractService< Batch, Integer > {
  ...
  public List< Batch> findByCreatedAtIsBetween(LocalDateTime startDateTime, LocalDateTime endDateTime) {
  return batchDao.findByCreatedAtIsBetween(startDateTime,endDateTime);
  }
}
